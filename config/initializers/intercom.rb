IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "cpj1t0b0"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = "ASOYX2FEt-8hVbPR02cOni0ja2wDiB04svV2eq-P"
  ...
  #
  config.api_key = "e9178e433d1922c0cbb766f4a0454e96d77069e3"
  ...
  config.user.custom_data = {
    :videos_count => Proc.new { |current_user| current_user.videos.count },
